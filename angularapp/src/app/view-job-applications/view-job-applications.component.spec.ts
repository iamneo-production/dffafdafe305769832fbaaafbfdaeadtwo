...
describe('ViewJobApplicationsComponent', () => {
  ...
  //   const applicantName = 'Applicant 1';
  //   const status = 'reject';

  //   jobService.updateApplicationStatus.and.returnValue(of({}));

  //   component.changeStatus(applicationId, applicantName, status);

  //   expect(jobService.updateApplicationStatus).toHaveBeenCalledWith(applicationId, applicantName, status);
  // });
});
