...
describe('JobPostingFormComponent (HTML)', () => {
  ...
  fit('JobPostingFormComponent should render the form fields', () => {
    ...
    expect(compiled.querySelector('input[id="title"][formControlName="title"]')).toBeTruthy();
    expect(compiled.querySelector('label[for="department"]').textContent).toContain('Department');
    expect(compiled.querySelector('input[id="department"][formControlName="department"]')).toBeTruthy();
    ...
    expect(compiled.querySelector('textarea[id="responsibilities"][formControlName="responsibilities"]')).toBeTruthy();
    expect(compiled.querySelector('label[for="qualifications"]').textContent).toContain('Qualifications');
    expect(compiled.querySelector('textarea[id="qualifications"][formControlName="qualifications"]')).toBeTruthy();
    expect(compiled.querySelector('label[for="applicationDeadline"]').textContent).toContain('Application Deadline');
    expect(compiled.querySelector('input[id="applicationDeadline"][formControlName="applicationDeadline"]')).toBeTruthy();
